...
keep <- rownames(m_abscessus_expression)
m_abscessus_expression <- m_abscessus_expression[keep, ]
m_abscessus_coexpression <- compute_coexpression(m_abscessus_expression)
...
for(n in 1:n_regulators){
  if(rstan::get_num_divergent(regulons_vague[[n]]$model_object) == 0 & length(rstan::get_low_bfmi_chains(regulons_vague[[n]]$model_object)) == 0 & length(which(rstan::summary(regulons_vague[[n]]$model_object)$summary[, "Rhat"] > 2)) == 0){
    print(n)
...
for(n in 1:n_regulators){
  if(rstan::get_num_divergent(regulons_informed[[n]]$model_object) == 0 & length(rstan::get_low_bfmi_chains(regulons_informed[[n]]$model_object)) == 0 & length(which(rstan::summary(regulons_informed[[n]]$model_object)$summary[, "Rhat"] > 2)) == 0){
    print(n)
...
for(n in 1:n_regulators){
  if(rstan::get_num_divergent(regulons_specific[[n]]$model_object) == 0 & length(rstan::get_low_bfmi_chains(regulons_specific[[n]]$model_object)) == 0 & length(which(rstan::summary(regulons_specific[[n]]$model_object)$summary[, "Rhat"] > 2)) == 0){
    print(n)
...
for(n in 1:n_regulators){
  if(rstan::get_num_divergent(regulons_vague[[n]]$model_object) == 0 & length(rstan::get_low_bfmi_chains(regulons_vague[[n]]$model_object)) == 0 & length(which(rstan::summary(regulons_vague[[n]]$model_object)$summary[, "Rhat"] > 2)) == 0 &
     rstan::get_num_divergent(regulons_informed[[n]]$model_object) == 0 & length(rstan::get_low_bfmi_chains(regulons_informed[[n]]$model_object)) == 0 & length(which(rstan::summary(regulons_informed[[n]]$model_object)$summary[, "Rhat"] > 2)) == 0 &
     rstan::get_num_divergent(regulons_specific[[n]]$model_object) == 0 & length(rstan::get_low_bfmi_chains(regulons_specific[[n]]$model_object)) == 0 & length(which(rstan::summary(regulons_specific[[n]]$model_object)$summary[, "Rhat"] > 2)) == 0){
    print(n)
